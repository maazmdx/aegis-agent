...
Built for the **All Things Agentic Hackathon** on **Google ADK + Gemini 3.5 Flash Lite + Cloud Run**.
...
flowchart LR
    ...
    SUP[Aegis Supervisor<br/>Google ADK + Gemini 3.5]
...
| LLM | Gemini (`gemini-3.5-flash-lite`) via `google-genai` |
